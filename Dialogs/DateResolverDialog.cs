...
namespace Microsoft.BotBuilderSamples.Dialogs
{
    ...
    {
        private const string PromptMsgText = "Let me know the expected Project Status date?";
        private const string RepromptMsgText = "I'm sorry, to get the project status please enter a full date including Day Month and Year.";
